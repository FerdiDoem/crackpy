...
| OQ-016 | How should CrackPy define a stable analysis-function identity and function-level version? | resolved | [[glossary#Analysis function identity]], [[refactor-candidates/010-provenance-metadata-architecture]], [[decision-log#2026-05-14-analysis-function-identity-is-a-stable-contract-id]] | C-003, C-010 |
