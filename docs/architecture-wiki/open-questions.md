...
| OQ-004 | Should line-intercept `window_size` be renamed conceptually and should related constructor arguments receive more precise planning vocabulary? | resolved | [[glossary#Min consecutive strain exceedance count]], [[glossary#Line-intercept evaluation region]], [[terminology-report#Window, Size, And Offset]], [[decision-log#2026-05-14-line-intercept-window-size-is-a-consecutive-strain-exceedance-count]] | Terminology cleanup |
...
| OQ-007 | Should crack-tip correction return values consistently mean relative shifts or absolute corrected crack-tip coordinates? | resolved | [[glossary#Corrected crack-tip estimate]], [[glossary#Correction delta]], [[crack-detection]], [[terminology-report#Unresolved Terminology Questions]], [[refactor-candidates/003-self-contained-williams-fit-interface]], [[decision-log#2026-05-14-crack-tip-correction-produces-corrected-estimates-and-deltas]] | C-003 |
...
| OQ-019 | Which metadata belongs in the compact knowledge-graph export and which belongs only in an optional detailed provenance artifact? | resolved | [[glossary#Compact knowledge-graph export]], [[glossary#Detailed provenance artifact]], [[glossary#Grouped metadata statement bundle]], [[refactor-candidates/010-provenance-metadata-architecture]], [[decision-log#2026-05-14-compact-kg-export-is-result-centric-detailed-provenance-is-process-centric]] | C-010 |
