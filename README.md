...
5. Calculate CJP stress intensity factors which may take effects of plasticity into account by fitting the theoretical displacement field of the _CJP model_ [**8**] to the experimental (or simulated) data [**13**]
...
and strains match the one used here (Check out our [Wiki](https://github.com/dlr-wf/crackpy/wiki)
...
4. **Melching D et al. (2022)** Explainable machine learning for precise fatigue crack tip detection.
...
8. **Yang B et al. (2021)** New algorithms for optimised fitting of DIC data to the crack tip plastic zone using the CJP model.
